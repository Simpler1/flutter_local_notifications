...
class _HomePageState extends State<HomePage> {
  ...
  initState() {
    ...
    var initializationSettingsIOS =
        IOSInitializationSettings(onDidReceiveLocalNotification: onDidRecieveLocalNotification);
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 8.0),
                    child: RaisedButton(
                      child: Text('Show plain notification with payload and update channel description'),
                      onPressed: () async {
                  ...
                  Padding(
                    padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 8.0),
                    child: RaisedButton(
                      child: Text('Repeat notification every day at approximately 10:00:00 am'),
                      onPressed: () async {
                  ...
                  Padding(
                    padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 8.0),
                    child: RaisedButton(
                      child: Text('Repeat notification weekly on Monday at approximately 10:00:00 am'),
                      onPressed: () async {
                  ...
                  Padding(
                    padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 8.0),
                    child: RaisedButton(
                      child: Text('Show big picture notification, hide large icon on expand [Android]'),
                      onPressed: () async {
                  ...
                  Padding(
                    padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 8.0),
                    child: RaisedButton(
                      child: Text('Show notification with no badge, alert only once [Android]'),
                      onPressed: () async {
                  ...
                  Padding(
                    padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 8.0),
                    child: RaisedButton(
                      child: Text('Show progress notification - updates every second [Android]'),
                      onPressed: () async {
                  ...
                  Padding(
                    padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 8.0),
                    child: RaisedButton(
                      child: Text('Show indeterminate progress notification [Android]'),
                      onPressed: () async {
  ...
  Future _showBigPictureNotification() async {
    var largeIconPath = await _downloadAndSaveImage('http://via.placeholder.com/48x48', 'largeIcon');
    var bigPicturePath = await _downloadAndSaveImage('http://via.placeholder.com/400x800', 'bigPicture');
  ...
  Future _showMessagingNotification() async {
    ...
    messages.add(
      Message('What\'s up?', DateTime.now().add(Duration(minutes: 5)), coworker),
    );
    messages.add(
      Message('Lunch?', DateTime.now().add(Duration(minutes: 10)), null, dataMimeType: 'image/png', dataUri: imageUri),
    );
    messages.add(
      Message('What kind of food would you prefer?', DateTime.now().add(Duration(minutes: 10)), lunchBot),
    );
  ...
  Future _showGroupedNotifications() async {
    ...
    var firstNotificationPlatformSpecifics = NotificationDetails(firstNotificationAndroidSpecifics, null);
    await flutterLocalNotificationsPlugin.show(
      1,
      'Alex Faarborg',
    ...
    var secondNotificationPlatformSpecifics = NotificationDetails(secondNotificationAndroidSpecifics, null);
    await flutterLocalNotificationsPlugin.show(
      2,
      'Jeff Chang',
